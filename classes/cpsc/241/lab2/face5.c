...
int main() {
   ...
   //Build the smiley face.
      ...
      smiley.insertLine (2.0, 1.75, 0.0, -1.0); // body
      smiley.insertLine (2.0, 1.5, 0.25, -0.25); // right arm
      smiley.insertLine (2.0, 1.5, -0.25, -0.25); // left arm
      smiley.insertLine (2.0, 0.75, 0.5, -0.5); // right leg
      smiley.insertLine (2.0, 0.75, -0.5, -0.5); // left leg
   // Display the face.
