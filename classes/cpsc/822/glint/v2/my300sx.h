...
struct glint_device {
	...
	unsigned long *k_control_base;
	unsigned long u_control_base;
	unsigned long *k_dac_base;
	unsigned long local_buffer_base;
	unsigned long *k_local_buffer_base;
	unsigned long frame_buffer_base;
	unsigned long *k_frame_buffer_base;
	struct dmagob {
		unsigned long phys_base;
		unsigned long *virt_base;
		unsigned long *kbase;
		unsigned long stored_count;
		} dmagob[MAX_DMA_POOL_BUFS];
	struct start_dma {
		unsigned long count;
		unsigned long *virt_base;	
		} start_dma_data;
